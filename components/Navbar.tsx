...
export default function Navbar() {
  ...
  const navItems = [t.nav.home, t.nav.menu, t.nav.order, t.nav.rewards, t.nav.about];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              {showSearch && (
                <div className="absolute right-0 top-14 w-72 bg-white rounded-2xl shadow-soft-lg p-3 border border-pastel-brown border-opacity-20 animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="mt-3 px-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {t.nav.tags.map((tag) => (
                        <span key={tag} className="px-3 py-1 bg-pastel-peach text-text-dark text-xs rounded-full cursor-pointer hover:bg-pastel-brown hover:text-white transition-colors">
                          {tag}
                        </span>
                      ))}
                    </div>
